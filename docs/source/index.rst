...
The graphical interface `**easyfermi** <https://github.com/ranieremenezes/easyfermi>` provides a user-friendly way to analyze *Fermi*-LAT data, making use of `fermipy <https://github.com/fermiPy/fermipy>`, `gammapy <https://gammapy.org/>`, `astropy <https://www.astropy.org/>`, and `emcee <https://emcee.readthedocs.io/en/stable/>`.
...
To acknowledge *easyfermi* in a publication please cite `de Menezes, R. 2022 <https://ui.adsabs.harvard.edu/abs/2022A%26C....4000609D/abstract>`.
